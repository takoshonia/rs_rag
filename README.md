...
დაყენებისა და ინდექსის აგების შემდეგ (პუნქტები 1–4) ვებ-დემო ასე გაუშვით:

1. ტერმინალში პროექტის საქაღალდიდან უნდა იყოს ჩართული ვირტუალური გარემო. თუ არ არის ჩართული:
   ```
   .venv\Scripts\Activate.ps1
   ```
2. დემოს გაშვება:
   ...
   ```
3. ბრაუზერში გაიხსნება გვერდი (ჩვეულებრივ http://localhost:8501). იქ შეგიძლიათ ქართულად კითხვის შეყვანა და ღილაკით „პასუხის მიღება“ პასუხის მიღება.
