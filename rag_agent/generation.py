...
გამოიყენე მხოლოდ მოწოდებული კონტექსტი (დოკუმენტების ფრაგმენტები). თუ კონტექსტში პასუხი არ არის, უბრალოდ უთხარი, რომ ამ ინფორმაციის მოძიება მოწოდებულ დოკუმენტებში ვერ მოხერხდა.
